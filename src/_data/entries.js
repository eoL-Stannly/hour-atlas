...
const entries = [
...

  {
    ...
    placeholder: true,
    body: [
      "The lagoon runs from almost colourless at the sand to a hard turquoise about thirty metres out, and the line between the two moves with the tide, so the same frame taken an hour apart is a different picture.",
    ...
    verdict:
      "Worth it for two or three days, less so for a week. The reef is the reason to come and you can see all of it before lunch on day two.",
    rating: 4,
...

  {
    ...
    placeholder: true,
    body: [
      "Sunset Beach faces exactly where you would want it to, which means by six every evening there are forty people standing in a line along the sand, all making the same picture. I made it too.",
    ...
    verdict:
      "Beautiful and quite busy, and those two facts are related. Go in the shoulder season or go to the next island along.",
    rating: 3,
...

  {
    ...
    placeholder: true,
    body: [
      "The cliff path east of the car park is the whole reason to come. It runs for about four kilometres along the top of the headland and you get a new arch or stack every few hundred metres.",
    ...
    verdict:
      "The best coastal walking in southern Europe for the effort involved, and almost empty outside July and August.",
    rating: 5,
...

  {
    ...
    placeholder: true,
    body: [
      "Four metres of rain a year is what makes the waterfalls, so the weather is not something to work around, it is the subject. The two days it did not rain were the two least interesting days.",
    ...
    verdict:
      "Go, and give it more days than you think you need, because you will lose at least two of them to weather that makes the road impassable.",
    rating: 5,
...

  {
    ...
    placeholder: true,
    body: [
      "The dunes only look like the pictures for about forty minutes either side of sunrise and sunset. In between they are flat, hazy and the colour of cardboard.",
    ...
    verdict:
      "One night is enough and two is plenty. Do the camp, get up in the dark, and do not bother changing lenses out there.",
    rating: 4,
...

  {
    ...
    placeholder: true,
    body: [
      "Up in the hills the light stays flat and soft most of the day because the cloud never fully clears, which is miserable for landscapes and excellent for anything green.",
    ...
    verdict:
      "The part of Bali worth the flight. Two hours from the south coast and it may as well be a different island.",
    rating: 5,
